...
FIX: 
    - Bug where containers with multiple exposed (but not all external routed) ports won't show up on landing page
...
- override version of dependency due to https://github.com/golang/dep/issues/1888
